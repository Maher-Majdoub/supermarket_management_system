...
"QPushButton:pressed{\n"
"}")
        self.param = QPushButton(Form)
        self.param.setObjectName(u"param")
        self.param.setGeometry(QRect(70, 730, 41, 41))
        self.param.setFont(font6)
        self.param.setCursor(QCursor(Qt.PointingHandCursor))
        self.param.setMouseTracking(False)
        self.param.setTabletTracking(False)
        self.param.setStyleSheet(u"border-image: url(:/icons/settings.png);")
        ...
        QWidget.setTabOrder(self.products_btn, self.param)
        QWidget.setTabOrder(self.param, self.stats_btn)
